...
describe('KssBuilderBaseTwig object API', function() {
  ...
  describe('KssBuilderBaseTwig constructor', function() {
    ...
    it('should implement the default option definitions', function() {
      let builder = new KssBuilderBaseTwig();
      expect(Object.getOwnPropertyNames(builder.optionDefinitions)).to.deep.equal(['source', 'destination', 'mask', 'clone', 'builder', 'css', 'js', 'custom', 'verbose', 'extend', 'extend-drupal8', 'namespace', 'homepage', 'placeholder', 'attribute-placeholder', 'nav-depth']);
    });
  });
